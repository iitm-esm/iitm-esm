...
#set echo
set platform      = intel_pratyush           # A unique identifier for your platform
...
cd ../
set root          = $cwd    # The directory you created when you checkout
cd exp
set code_dir      = $root/src                         # source code directory
set executable    = $root/exec_$platform/$type/cfs_ocean_mom4ice   # executable created after compilation
...
set cppDefs       = ( "-Duse_netCDF4 -DNO_DEV_NULL -DUSE_OCEAN_BGC -DENABLE_ODA" ) # list of cpp #defines to be passed to the source files
#if($MPI) set cppDefs  = ( "-Duse_netCDF4 -Duse_libMPI -DUSE_OCEAN_BGC -DENABLE_ODA" )
if($MPI) set cppDefs  = ( "-Duse_netCDF4 -Duse_libMPI -DENABLE_ODA -DUSE_OCEAN_BGC" )
...
if ( $MPI && ! -f $mppnccombine ) then
      icc -O -o $mppnccombine -I/gpfs1/home/Libs/INTEL/NETCDF4/netcdf-4.2.1/include -L/gpfs1/home/Libs/INTEL/NETCDF4/netcdf-4.2.1/lib $code_dir/postprocessing/mppnccombine/mppnccombine.c -lnetcdf
endif
...
#set srcList = ( mom4p1/ocean_core mom4p1/ocean_diag mom4p1/ocean_param/sources mom4p1/ocean_param/mixing mom4p1/ocean_param/gotm-4.0/include mom4p1/ocean_param/gotm-4.0/turbulence mom4p1/ocean_param/gotm-4.0/util mom4p1/ocean_tracers  atmos_null coupler ice_sis ice_param rivers )
