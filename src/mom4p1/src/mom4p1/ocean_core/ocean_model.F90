...
use ocean_density_mod,            only: ocean_density_restart, ocean_density_diag !<-- esm insertion
...
!!!!!!!!!!!!Time%init restored to false 14th august 2012!!!!!!!!
    if(Time%init) then 
      write(stdoutunit,'(/a)')&
    ...
    !write (stdoutunit,*) 'Test_ocean: set_ocean_domain starts'
    call set_domain(Domain%domain2d)
    !write (stdoutunit,*) 'Test_ocean: set_ocean_domain ends'

    call ocean_workspace_init(Domain, Grid)
    call set_ocean_hgrid_arrays(Domain, Grid)
    !write (stdoutunit,*) 'Test_ocean: ocean_topog_init starts'
    call ocean_topog_init(Domain, Grid, 'INPUT/grid_spec.nc', vert_coordinate_type)
    !write (stdoutunit,*) 'Test_ocean: ocean_topog_init ends and obc/vgrid/util_init starts'
    ...
    !write (stdoutunit,*) 'Test_ocean: obc/vgrid/util_init ends'
...
!
  subroutine update_ocean_model(Ice_ocean_boundary, Ocean_state, Ocean_sfc, &
    ...
    !print *, 'Test_ocean_model: before ocean loop, num_ocean_calls=', num_ocean_calls
    ! Loop over num_ocean_calls, moved here from the coupler due to interface changes
    do num_ocn = 1,num_ocean_calls
       !print *, 'Test_ocean_model: ocean loop starts, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after mixdownslope, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after ocean_mass_forcing, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after eta_and_pbot_tendency, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after ocean_advection_velocity, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after eta_and_pbot_update, num_ocn=', num_ocn 
       ...
       !print *, 'Test_ocean_model: ocean loop after update_tcell_thickness, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after sigma_transport, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after neutral_physics, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after update_ocean_tracer, num_ocn=', num_ocn
       ...
       !print *, 'Test_ocean_model: ocean loop after update_ocean_density, num_ocn=', num_ocn
    ...
    !print *, 'Test_ocean_model: ocean loop after update_ocean_velocity, num_ocn=', num_ocn
    ...
    !print *, 'Test_ocean_model: ocean loop ends, num_ocn=', num_ocn
