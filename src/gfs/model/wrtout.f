...
!sela set lfnhr to false for writing one step output etc.
     ...
     &      '("(I",I1,".",I1,",A1,I2.2,A1,I2.2)")') NDIG,NDIG
      ...
      write(CFHOUR,'("_",I4.4,I2.2,I2.2,I2.2,I2.2,I2.2)') 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     &        phy_f3d, phy_f2d, ngptc, nblck, adiab, time)
!!
      use resol_def
      use layout1
      use mpi_def
...
!!
      real runid,usrid
      integer n3,n4,nflop
      character(len=50) :: sigr51, sigr52, cflop
      real pdryini
      integer nn, yy, mm, dd, hh, mns, secs
     ...
     &                  yy,mm,dd,hh,mns,secs
        ...
        sigr51 = 'RESTART/'//datestamp//'sig_ini'
        sigr52 = 'RESTART/'//datestamp//'sig_ini2'
        cflop  = 'RESTART/'//datestamp//'sfc_ini'
      else
        sigr51 = 'RESTART/sig_ini'
        sigr52 = 'RESTART/sig_ini2'
        cflop  = 'RESTART/sfc_ini'
      endif
...
!
        call sfcio_swohdc(nw,trim(cfile),head,data,iret)
!
      endif
      return
      end
