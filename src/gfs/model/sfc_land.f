...
!  ---  inputs:
     ...
     &       zorl, tg3, cm, ch, rcl, prsl1, prslki, slimsk,             &
     &       ddvel, flag_iter, flag_guess,                              &
!  ---  input/outputs:
     &       sheleg, tskin, tprcp, srflag, stc, canopy, tsurf,          & 
!  ---  outputs:
     &       qsurf, snowmt, gflux, zsoil, rhscnpy, rhsmc,               &
     &       aim, bim, cim, drain, evap, hflx, ep, cmm, chh,            &
     &       z1, evbs, evcw, trans, sbsno, snowc, stm, snohf            &
     &     )
...
!                                                                       !
!  program history log:                                                 !
!         xxxx  -- k. mitchell et al. land group created.               !
...
!                     that is redefined as (du-up). reformatted code    !
!                     and added program documentation block.            !
!                                                                       !
!                                                                       !
...
!  ---  locals:
      real (kind=kind_phys), dimension(im) :: sheleg_old, tprcp_old,    &
     ...
     &       partlnd, psurf, q0, qs1, qss, rcap, rch, rho, rs, rsmall,  &
     &       slwd, smcz, snoevp, snowd, term1, term2, theta1, tv1,      &
     &       tsea, xx, xrcl, yy, zz, ps1, kt1, kt2, twilt, tref
