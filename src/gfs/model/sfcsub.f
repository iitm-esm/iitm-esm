...
c  equally-spaced latitudes including poles
      elseif(idrt.eq.0) then
        ...
        enddo
        call dgetrf(awork,jhe,jho,ipvt)
        call dgetrs(awork,jhe,jho,ipvt,bwork,j0)
...
c  equally-spaced latitudes excluding poles
      elseif(idrt.eq.256) then
        ...
        do js=1,jho
          bwork(js)=-d1/(4*(js-1)**2-1)
        enddo
        call dgetrf(awork1,jhe,jho,ipvt)
        call dgetrs(awork1,jhe,jho,ipvt,bwork,j0)
